...
{
    // My components -- 2 * sliders, 1 * button, 1 * label
    m_pPluginTitle   = new Label (String::empty, "My Vibrato VST!!");
    addAndMakeVisible(m_pPluginTitle);
    m_pPluginTitle->setBounds(10, 10, 280, 20);
    
    
    m_pModFreqSlider = new Slider ("Mod Freq Slider");
    addAndMakeVisible(m_pModFreqSlider);
    m_pModFreqSlider->setBounds(20, 40, 260, 20);
    
    m_pModAmpSlider  = new Slider ("Mod Amp Slider");
    addAndMakeVisible(m_pModAmpSlider);
    m_pModAmpSlider->setBounds(20, 70, 260, 20);
    
    m_pBypassButton  = new TextButton ("Bypass Button");
    addAndMakeVisible(m_pBypassButton);
    m_pBypassButton->setBounds(20, 100, 260, 20);
